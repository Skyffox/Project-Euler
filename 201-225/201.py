...
# }
#
# /* Checkfor the existence of a table. */
...
# <?php
#
# define('DB_SERVER', 'database-2.cblqegibzlkc.us-east-1.rds.amazonaws.com');
# define('DB_USERNAME', 'admin'); //master user name
# define('DB_PASSWORD', 'cociry67');
